                ...
                <div className="blog-cards">
                    ...
                    <label style={blog3 ? {cursor: 'inherit'} : {cursor: "pointer"}} className="blog-card" htmlFor="blog-item-3" id="blog-slide-3" onClick={() => handleBlog3()}>
                        <div className="blog-content">
                            ...
                            <div className="blog-text-content">
                                <h1 className='blog-title'><a style={blog3 ? null : {pointerEvents: "none"}} href='https://medium.com/@venegasdavidm/the-best-ruby-enumerables-6d71fa5f933e' target="_blank" rel="noreferrer">Electrical Activity in Antagonistic Muscles</a></h1>
                                <div className="blog-start-wrap">
